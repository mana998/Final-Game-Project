...
function createDifficultyScreen() {
  if (!$('#difficultySelection').children().length) {
    $('#difficultySelection').append(`
            ...
            <button type="button" class="difficultyButton backgroundPicture smallButton" onClick="createGame(0)">
              <span class="buttonText orangeText">EASY</span>
            </button>
            <button type="button" class="difficultyButton backgroundPicture smallButton" onClick="createGame(1)">
              <span class="buttonText orangeText">HARD</span>
            </button>
        `);
  }
}
